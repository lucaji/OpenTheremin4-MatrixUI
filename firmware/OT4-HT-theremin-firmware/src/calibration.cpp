...
void printCalibrationDetails() {
    ...
    float voPitchFreq = PITCH_FIXED_OSCILLATOR_FREQUENCY - pitchBeatHz;
    float voVolFreq = VOLUME_FIXED_OSCILLATOR_FREQUENCY - volBeatHz;
    ...
    Serial.print(F("Pitch ticks:        ")); Serial.println(pitchCalibrationBase);
    Serial.print(F("Pitch beat freq:    ")); Serial.print(pitchBeatHz, 2); Serial.println(F(" Hz"));
    Serial.print(F("VO_PITCH freq:    ")); Serial.print(voPitchFreq, 2); Serial.print(F(" Hz (vs ")); Serial.print(PITCH_FIXED_OSCILLATOR_FREQUENCY - PitchFreqOffset); Serial.println(F(" Hz target)"));
    DEBUG_PRINT(F("P_DAC="));DEBUG_PRINTLN(pitchDAC);

    Serial.println();

    Serial.print(F("Volume ticks:     ")); Serial.println(volCalibrationBase);
    Serial.print(F("Volume beat freq: ")); Serial.print(volBeatHz, 2); Serial.println(F(" Hz"));
    Serial.print(F("VO_VOL freq:        ")); Serial.print(voVolFreq, 2); Serial.print(F(" Hz (vs ")); Serial.print(VOLUME_FIXED_OSCILLATOR_FREQUENCY - VolumeFreqOffset); Serial.println(F(" Hz target)"));
    DEBUG_PRINT(F("V_DAC="));DEBUG_PRINTLN(volumeDAC);
...
bool calibration_start() {    
    ...
    Serial.write(success?STATE_CMD_CALIBRATION_SUCCESS:STATE_CMD_CALIBRATION_ERROR);
    return success;
}
